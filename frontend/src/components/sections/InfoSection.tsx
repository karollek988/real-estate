    ...
    <section id="information" className="relative scroll-mt-24">
      ...
      <div className="relative mx-auto w-full max-w-[1400px] px-6 py-20">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          {INFO_CARDS.map(({ icon: Icon, title, description, points }, i) => (
            <Reveal key={title} variant="up" delay={i * 90} className="h-full">
              <div className="flex h-full flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-7 transition duration-300 hover:border-green-500/30 hover:bg-white/[0.05]">
